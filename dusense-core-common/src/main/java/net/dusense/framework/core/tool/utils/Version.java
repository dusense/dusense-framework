 ...
 * 版本号比较工具
 *
 * <p>思路来源于： https://github.com/hotoo/versioning/blob/master/versioning.js
 *
 * <p>example * ##完整模式 Version.of("v0.1.1").eq("v0.1.2"); // false
 *
 * <p>##不完整模式 Version.of("v0.1").incomplete().eq("v0.1.2"); // true
 *
 * <p>email: 596392912@qq.com site:http://www.dreamlu.net date 2015年7月9日下午10:48:39
 */
public class Version {
     ...
     * 比较版本号是否相同
     *
     * <p>example: * Version.of("v0.3").eq("v0.4")
     *
     ...
     * 不相同
     *
     * <p>example: * Version.of("v0.3").ne("v0.4")
     *
     * @param version 字符串版本号
     * @return {boolean}
     */
