package net.dusense.framework.core.tool.support;
...
public class FastStringWriter extends Writer {
     ...
     *
     * <p>Depending on the specification of <tt>toString</tt> for the character sequence
     * <tt>csq</tt>, the entire sequence may not be appended. For instance, invoking the
     * <tt>toString</tt> method of a character buffer will return a subsequence whose content
     ...
     *
     * <p>An invocation of this method of the form <tt>out.append(c)</tt> behaves in exactly the
     * same way as the invocation
     *
     * <pre>
     *     out.write(c) </pre>
