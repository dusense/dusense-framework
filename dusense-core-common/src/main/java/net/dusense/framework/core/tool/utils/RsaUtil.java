 ...
 * RSA加、解密工具
 *
 * <p>1. 公钥负责加密，私钥负责解密； 2. 私钥负责签名，公钥负责验证。
 */
public class RsaUtil {
    ...
    public static PublicKey getPublicKey(String base64PubKey) {
        ...
        byte[] keyBytes = Base64.decodeBase64(base64PubKey);
    ...
    public static PrivateKey getPrivateKey(String base64PriKey) {
        ...
        byte[] keyBytes = Base64.decodeBase64(base64PriKey);
    ...
    public static String encryptByPrivateKeyToBase64(String base64PrivateKey, byte[] data) {
        return Base64.encodeBase64String(encryptByPrivateKey(base64PrivateKey, data));
    }
    ...
    public static String encryptToBase64(String base64PublicKey, @Nullable String data) {
        ...
        return Base64.encodeBase64String(
                encrypt(base64PublicKey, data.getBytes(StandardCharsets.UTF_8)));
    }
    ...
    public static String decryptFromBase64(String base64PrivateKey, @Nullable String base64Data) {
        ...
        return new String(
                decrypt(base64PrivateKey, Base64.decodeBase64(base64Data)), StandardCharsets.UTF_8);
    }
    ...
    public static byte[] decryptFromBase64(String base64PrivateKey, byte[] base64Data) {
        return decrypt(base64PrivateKey, Base64.decodeBase64(base64Data));
    }
    ...
    public static String decryptByPublicKeyFromBase64(
        ...
        return new String(
                decryptByPublicKeyFromBase64(base64PublicKey, Base64.decodeBase64(base64Data)),
