package net.dusense.framework.core.exception;
...
public class UnknownException extends RuntimeException {
    ...
    public UnknownException(String m_message) {
        this.m_message = m_message;
    }

    public UnknownException(String m_message, Throwable m_root) {
        //		this.m_message=m_message;
        //		this.m_root=m_root;
        super(m_message, m_root);
    }

    public UnknownException(String m_message, String m_details, Throwable m_root) {
        this.m_message = m_message;
