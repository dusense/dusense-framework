...
public class INetUtil {
     ...
     *
     * <p>Returns an <code>InetAddress</code> object encapsulating what is most likely the machine's
     * LAN IP address.
     *
    ...
    private static InetAddress getLocalHostLANAddress() throws UnknownHostException {
        try {
            ...
            if (candidateAddress != null) {
                ...
                // address.
                // Server might have a non-site-local address assigned to its NIC (or it might be
                // running
