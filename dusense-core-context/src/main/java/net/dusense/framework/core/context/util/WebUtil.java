package net.dusense.framework.core.context.util;
...
public class WebUtil extends org.springframework.web.util.WebUtils {
    ...
    /** AJAX失败响应 response Status */
    public static void ajaxFailed(
     ...
     * @param result 结果对象
     */
    public static void renderJson(HttpServletResponse response, int responseStatus, Object result) {
    ...
    public static void renderJson(HttpServletResponse response, Object result, String contentType) {
        ...
        try (PrintWriter out = response.getWriter()) {
            out.append(JacksonUtils.toJsonString(result));
        } catch (IOException e) {
    ...
    private static final Predicate<String> IP_PREDICATE =
            (ip) -> StringUtils.isBlank(ip) || StringPool.UNKNOWN.equalsIgnoreCase(ip);
    ...
    public static String getRequestContent(HttpServletRequest request) {
        try {
            ...
            if (StringUtils.isNotBlank(queryString)) {
                return new String(
                                queryString.getBytes(StandardCharsets.ISO_8859_1),
