...
/** 配置文件 */
@ConfigurationProperties("dusense")
public class DusenseProperties implements EnvironmentAware, EnvironmentCapable {
    @Nullable private Environment environment;

    /** 装载自定义配置dusense.prop.xxx */
    @Getter private final Map<String, String> prop = new HashMap<>();
    ...
    public String getEnv() {
        ...
        String env = environment.getProperty("dusense.env");
        Assert.notNull(env, "请使用 Application 启动...");
        return env;
    }
    ...
    public String getName() {
        ...
        return environment.getProperty(
                "spring.application.name", environment.getProperty("dusense.name", ""));
    }
