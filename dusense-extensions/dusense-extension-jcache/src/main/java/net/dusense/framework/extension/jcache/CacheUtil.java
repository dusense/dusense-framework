package net.dusense.framework.extension.jcache;

import net.dusense.framework.core.context.support.SpringContextHolder;
import net.dusense.framework.core.context.support.UserContextHolder;
...
public class CacheUtil {
    ...
    public static String formatCacheName(String cacheName, Boolean tenantMode) {
        ...
        return (StringUtils.isBlank(tenantId)
                ? cacheName
                : tenantId.concat(StringPool.COLON).concat(cacheName));
    }
    ...
    public static Object get(String cacheName, String keyPrefix, Object key, Boolean tenantMode) {
        ...
        Cache.ValueWrapper valueWrapper =
                getCache(cacheName, tenantMode).get(keyPrefix.concat(String.valueOf(key)));
    ...
    public static <T> T get(
            String cacheName, String keyPrefix, Object key, @Nullable Class<T> type) {
    ...
    @Nullable
    public static <T> T get(
            String cacheName, String keyPrefix, Object key, Callable<T> valueLoader) {
        ...
        try {
            ...
            if (valueWrapper == null) {
                ...
                if (ObjectUtils.isNotEmpty(call)) {
                    // TODO 反射差别..
                    //
                    //                    Field field = ReflectUtil.getField(call.getClass(),
                    // DusenseConstant.DB_PRIMARY_KEY);
                    //                    if (ObjectUtils.isNotEmpty(field) &&
                    // ObjectUtils.isEmpty(ClassUtil.getMethod(call.getClass(),
                    // DusenseConstant.DB_PRIMARY_KEY_METHOD).invoke(call))) {
                    //                        return null;
                    //                    }
                    getCache(cacheName, tenantMode)
                            .put(keyPrefix.concat(String.valueOf(key)), call);
                    value = call;
                }
            } else {
